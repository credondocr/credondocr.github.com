<?php
	...
	$mail->Port       	= 587;
	$mail->Username   	= 'credondocr@gmail.com';
	$mail->Password   	= 'wpQ6nTDV1Nwqklf0rCARjQ';
	$mail->Subject    	= 'New '.$formTypes[$_POST['type']]. ' Message from redondocr.com';
	$mail->CharSet		= 'utf-8';
	$mail->WordWrap 	= 50;
	
	$mail->SetFrom('credondocr@gmail.com', 'redondocr.com');

	$mail->AddAddress('credondocr@gmail.com');
